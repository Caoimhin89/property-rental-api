...
CREATE TYPE notification_type AS ENUM (
  'BOOKING_REQUESTED', 'BOOKING_APPROVED', 'BOOKING_REJECTED', 'BOOKING_CANCELLED',
  ...
  'REVIEW_REQUESTED', 'REVIEW_REMINDER', 'REVIEW_FOLLOWUP', 'REVIEW_PUBLISHED',
  'PROPERTY_CREATED', 'PROPERTY_APPROVAL_REQUIRED', 'PROPERTY_APPROVAL_REQUIRED_REMINDER', 'PROPERTY_APPROVED', 'PROPERTY_REJECTED',
  'ORGANIZATION_INVITATION', 'ORGANIZATION_INVITATION_REMINDER', 'ORGANIZATION_MEMBER_ADDED', 'ORGANIZATION_MEMBER_REMOVED',
  'OTHER'
);
